---
name: pict
description: Render what a session opens with — the whole injected context, in wire order — and put it on screen. Runs in the JStack UserPromptSubmit hook — no model turn.
